...
def init_session_state():
    ...
    # 모델명에 버전을 붙여서 캐시 무효화 강제 (v=2)
    st.session_state.agent = get_agent(st.session_state.provider, GOOGLE_API_KEY, model_name=f"{GEMINI_MODEL}::v2")
